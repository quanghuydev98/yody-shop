...
import InfinityListMan from "../../components/InfinityListMan";
...
const Male = () => {
  ...
  const updateProducts = useCallback(() => {
    let temp = productData.getAllProductsMan();
  ...
  return (
    <Helmet title="Thời trang nam đẹp, phong cách, trẻ trung">
